...
public class Teste{
	...
	private static void usandoEnum(){
		//Criei uma variavel do tipo DiaSemana chamada segunda e atribui o enum SEGUNDA a essa variavel
		
		//DiaSemana segunda = DiaSemana.SEGUNDA;
		DiaSemana terca = DiaSemana.TERCA;
		//DiaSemana terca = 10;     -----------> nao funciona
	...
	private static void imprimeDiaSemana(DiaSemana dia){
		...
		switch(dia){
			...
			case TERCA: System.out.println("Terca Feira"); break;
